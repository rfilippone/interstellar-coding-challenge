...
public class VisibleProcessorTest {
  ...
  @Test(expected = NotEnoughImages.class)
  public void cannotProcessMissingB02Granule() throws NotEnoughImages {
  ...
  @Test(expected = NotEnoughImages.class)
  public void cannotProcessMissingB03Granule() throws NotEnoughImages {
    Granule granule = Granule.fromfiles(
  ...
  @Test(expected = NotEnoughImages.class)
  public void cannotProcessMissingB04Granule() throws NotEnoughImages {
    Granule granule = Granule.fromfiles(
